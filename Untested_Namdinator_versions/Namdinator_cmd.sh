...
#NAMD v. 2.12 cuda
NAMDMASTER="/opt/bioxray/programs/namd-cuda-2.12"

#Rosetta bin
ROSETTA_BIN="/opt/bioxray/programs/rosetta_bin_linux_2017.08.59291_bundle/main/source/bin"

#Phenix package 
PHENIXMASTER=/usr/local/phenix-dev-2614
...
source ${PHENIXMASTER}/phenix_env.sh
PATH=${ROSETTA_BIN}:${NAMDMASTER}:${VMDMASTER}/bin:${PATH}
LD_LIBRARY_PATH=${VMDMASTER}/lib:${LD_LIBRARY_PATH}
