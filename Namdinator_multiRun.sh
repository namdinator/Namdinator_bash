...
phenix.real_space_refine last_frame_rnd2.pdb $MAPIN resolution=$RES
...
phenix.real_space_refine last_frame_rnd3.pdb $MAPIN resolution=$RES
...
score_jd2.mpi.linuxgccrelease -in:file:s last_frame_rsr_rnd2.pdb -ignore_unrecognized_res -edensity::mapfile ${MAP}.mrc -edensity::mapreso ${RES} -edensity:fastdens_wt 20.0 -edensity::cryoem_scatterers -crystal_refine -out:file:scorefile lf_rsr_rnd3.sc > lf_rsr_rnd3_rosetta.log & PID[34]=$!
...
per_residue_energies.mpi.linuxgccrelease -in:file:s last_frame_rsr.pdb > lf_rsr_perRes.log 
sort -k21 -n -r default.out > lf_rsr_perRes.sc
rm default.out

per_residue_energies.mpi.linuxgccrelease -in:file:s lf_rsr_rnd2.pdb > lf_rsr_rnd2_perRes.log 
sort -k21 -n -r default.out > lf_rsr_rnd2_perRes.sc
rm default.out

per_residue_energies.mpi.linuxgccrelease -in:file:s lf_rsr_rnd3.pdb > lf_rsr_rnd3_perRes.log 
...
mv last_frame_rnd*.pdb $DIREC1/ 2> /dev/null
